...
def _load_discord_env():
    ...
    hassan_env.CMD_AUTODEL_CHANNEL_PATH = os.path.dirname(os.path.abspath(__file__)) + '/.concmdAutodelChannel'

def _load_favorite_env():
    hassan_env.FAVORITE_PATH = os.path.dirname(os.path.abspath(__file__)) + '/favorites/'
    hassan_env.FAVORITE_MAX = int(os.getenv('FAVORITE_MAX'))

def _load_cache_env():
    hassan_env.CACHE_PATH = os.path.dirname(os.path.abspath(__file__)) + '/.cache/'
